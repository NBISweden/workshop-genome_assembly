...
Here are links to some manuals. You don't have to read through all of it, but you should get a glimpse of what it will be like to use the software. The top three are discussion fora, which could be useful to answer questions that are not covered by the manuals.
